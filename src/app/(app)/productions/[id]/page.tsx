...
import { addScene, updateScene, removeScene } from "@/lib/actions/scenes";
import {
  addAsset,
  updateAsset,
  removeAsset,
...
import {
  ...
  updateSoundCue,
  removeSoundCue,
} from "@/lib/actions/sound-cues";
import {
  addLampCue,
  updateLampCue,
  removeLampCue,
} from "@/lib/actions/lamp-cues";
import {
  addVideoTask,
  updateVideoTask,
  removeVideoTask,
} from "@/lib/actions/video-tasks";
      ...
      <Tabs defaultValue="storyboard">
        ...
        <TabsContent value="assets" className="mt-4">
          <AssetTabPane
            ...
            users={users}
            onAdd={() => {
              void addAsset(production.id).then((created) => {
